...
<head>
    ...
    <script>
        ...
        function navigateToModule(module) {
            ...
            } else if (module === 'leaveRecordEmployee') {
                form.action = 'leaveRecordEmployee.jsp';
            } else if (module === 'leaveRecordPersonal') {
                form.action = 'leaveRecordPersonal.jsp';
            } else if (module === 'profile') {
                form.action = 'profile.jsp';
            } else if (module === 'addEmployee') {
                form.action = 'addEmployee.jsp';
            }else if (module === 'viewEmployee') {
...
<body>
	<div class="container">
	    ...
	    <!-- Dropdown menu for Leave Record -->
	    <div class="dropdown">
	        <button class="dropbtn">Leave Record</button>
	        <div class="dropdown-content">
	            <a href="javascript:void(0);" onclick="navigateToModule('leaveRecordEmployee')">Employee Record</a>
	            <a href="javascript:void(0);" onclick="navigateToModule('leaveRecordPersonal')">Personal Record</a>
	        </div>
	    </div>
	    ...
	    <a href="javascript:void(0);" onclick="navigateToModule('addEmployee')">Add Employee</a><br>
	    <a href="javascript:void(0);" onclick="navigateToModule('viewEmployee')">View Employee</a><br>
